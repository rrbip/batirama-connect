...
| [20_handoff_humain_support.md](./20_handoff_humain_support.md) | Système de handoff humain pour le support IA (escalade, email bidirectionnel) |
| [21_llm_providers.md](./21_llm_providers.md) | Configuration multi-providers LLM (Ollama, Gemini, OpenAI) |
