...
return new class extends Migration
{
    ...
    {
        // Vision LLM Settings - Skip if already exists (created by 2025_12_28_161801)
        if (!Schema::hasTable('vision_settings')) {
        ...
        // Q/R Atomique Settings - Skip if already exists
        if (!Schema::hasTable('qr_atomique_settings')) {
        ...
        // Pipeline Tools Settings (default tools per file type) - Skip if already exists
        if (!Schema::hasTable('pipeline_tools_settings')) {
